...
export const Header = () => {
  ...
  return (
    ...
    >
        ...
        text-center gap-2 bg-white px-6 py-1 rounded-full
        ...
        className='sm:text-lg text-white bg-black w-auto mt-6 px-8 py-2
        ...
        className='mt-2 text-neutral-600'>Generated images from MindCanvas</motion.p>
    </motion.div>
  )
}
