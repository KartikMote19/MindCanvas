...
export const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
        <Link to='/'> 
        <img src={assets.logo} alt="" className='w-34 sm:w-40 lg:w-48' />
        </Link>
        ...
        <div>
            ...
            <div className='flex items-center gap-2 sm:gap-3'>
                ...
                px-4 sm:px-2 py-1.5 sm:py-2 rounded-full 
                ...
                <p className='text-gray-600 max:sm:hidden pl-4'>Hi, {user.name}</p>
                    <div className='relative group'>
                        ...
                        top-0 right-0 z-10 text-black rounded pt-12'>
                            ...
                            border text-sm'>
                                <li onClick= {logout} className='py px-4 cursor-pointer pr-15'>Logout</li>
                            </ul>
            ...
            <div className='flex items-center gap-2 sm:gap-5'>
                ...
                <button onClick={()=>setShowLogin(true)} className='bg-zinc-800
                 text-white px-7 py-1 sm:px-5 text-sm rounded-full'>Login</button>
            </div>
            }
        </div>
